...
//点触事件
    ...
    Layer.prototype.view = function () {
        ...
        layerbox.innerHTML = (config.shade ? '<div ' + (typeof config.shade === 'string' ? 'style="' + config.shade + '"' : '') + ' class="layui-m-layershade"></div>' : '')
            ...
            + (config.closeBtn ? '<div class="close-btn">关闭</div>' : '')
            + title
        ...
        $layerBox.find('.layui-m-layercont').append(config.content)
        $layerBox.css('z-index', $.getNextZIndex())
    ...
    Layer.prototype.action = function (config, elem) {
        ...
        if (config.closeBtn) {
            ready.touch(elem.querySelector('.close-btn'), function () {
